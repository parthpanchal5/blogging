...
<nav class="navbar navbar-expand-lg gradient-4 shadow p-1 mb-1 navbar-default navbar-fixed-top animated slideInDown">
  <div class="container">
...
<div class="container pt-5">
  <div class="row">
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
      <div class="card bg-white shadow p-1 text-black mb-2 animated fadeIn" id="card-hover">
        <img class="card-img-top" alt="">
        <div class="card-body">
          <h4 class="card-title text-center">Forgot Password?</h4><hr>
          <form action="#" method="POST">
            <div class="form-group">
              <label for="Email">Email</label>
              <input type="text" class="form-control input-rounded" placeholder="Registered Email" autofocus>
            </div>
            <div class="form-group">
